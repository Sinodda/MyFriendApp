...
class MyFriendAdapter(private val context: Context, private val items: ArrayList<MyFriend>) :RecyclerView.Adapter<MyFriendAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView:View):RecyclerView.ViewHolder(itemView) {
        ...
        private var txtFriendEmail: TextView = itemView.findViewById(R.id.txtFriendName)
        private var txtFriendTelp: TextView = itemView.findViewById(R.id.txtFriendName)
